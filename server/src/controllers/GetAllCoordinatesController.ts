...
export class GetAllCoordinatesController {
	handle(request: Request, response: Response) {
		...
		const { sequentialDay, time } = getDates.execute()
		...
		// const saveCoordinates = saveCoordinatesService.execute(virtualCoordinates, realCoordinates, differenceCoordinates)
